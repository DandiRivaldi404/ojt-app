                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-validation">
                                <form class="form-valide" action="{{ route('mdnilaiinstansi.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div id="daftarNilaiContainer">
                                        ...
                                        <div class="form-group row" id="daftarNilaiGroup">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" placeholder="Masukkan Daftar Nilai" name="daftar_nilai_instansi[]" required>
                                            </div>
                                            <div class="col-lg-2">
